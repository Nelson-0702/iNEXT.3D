...
In this document, we provide a quick introduction demonstrating how to run the package `iNEXT.3D`(iNterpolation and EXTrapolation in three Dimensions). `iNEXT.3D` has severl main functiona: `iNEXT3D`, `ggiNEXT3D`, `obs3D`, `asy3D`, `ggasy3D`, and `DataInfo3D.`
