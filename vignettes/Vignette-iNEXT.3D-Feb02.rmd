...
For example, the dataset `Brazil_rainforest_abun_data` included in the `iNEXT.3D` package consists of species sample abundances of two assemblages/habitats: ?€œEdge?€? and ?€œInterior?€?. Run the following code to view the first 15 rows of the abundance data. 
